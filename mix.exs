...
defmodule Bonfire.Search.MixProject do
  ...
  def project do
    [
      ...
      deps: Mess.deps [
        ...
        # {:activity_pub, git: "https://github.com/bonfire-ecosystem/activitypub", branch: "develop", optional: true}
      ]
    ]
  end
  ...
  def application do
    [
      # mod: {Bonfire.Search.FallbackApplication, []},
